...
import { Download, FileText, User } from '@flama/design-system-mobile/icons';
import { MailboxTag } from '@flama/design-system-mobile/mailbox-tag';
import {
  MessageAttachment,
  MessageReader,
  MessageReaderBody,
...
} from '@flama/design-system-mobile/message-reader';
