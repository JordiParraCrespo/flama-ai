import { AlertDescription, Alert as InlineAlert } from '@flama/design-system-mobile/alert';
  ...
  return (
    <View className="flex-row items-center justify-between">
      <View className="flex-row items-center gap-3">
        ...
        <Text className="text-xl font-medium text-foreground">Flama Control</Text>
      </View>
      <Pressable
