...
import { Controller, Delete, HttpCode, Param, UseGuards, Version } from '@nestjs/common';
...
export class DeleteFlagSegmentHttpController {
  ...
  async deleteFlagSegment(
    ...
    await this.commandBus.execute(new DeleteFlagSegmentCommand({ key, actorId: actor.id }));
  }
}
