...
/**
 * The identity providers' own marks, inlined rather than pulled from the design
 * system's icon set: Lucide dropped brand logos, and Google's has to keep its
 * four colours, which a monochrome set cannot carry.
 */
...
export function GithubIcon({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="presentation"
      className={cn('size-[17px] shrink-0 text-ink-900', className)}
      {...props}
    >
      <path
        fill="currentColor"
