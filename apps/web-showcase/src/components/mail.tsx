...
import { FilterMenu } from "@flama/design-system-web/filter-menu";
import { IconButton } from "@flama/design-system-web/icon-button";
import {
  MailboxPicker,
  type MailboxOption,
} from "@flama/design-system-web/mailbox-picker";
import {
  MailboxRail,
  MailboxRailDomain,
  MailboxRailGroup,
  ...
  MailboxRailRow,
  MailboxRailSearch,
} from "@flama/design-system-web/mailbox-rail";
import { MailboxChip, MailboxTag } from "@flama/design-system-web/mailbox-tag";
import {
  MessageList,
  MessageListItem,
} from "@flama/design-system-web/message-list";
import {
  MessageAttachment,
  MessageReader,
  MessageReaderBody,
...
} from "@flama/design-system-web/message-reader";
import { ReplyBox } from "@flama/design-system-web/reply-box";
import {
  CircleDotIcon,
  DownloadIcon,
  FileTextIcon,
