...
const WEB_SECTION = `import { useTranslation } from 'react-i18next';\n\n/**\n * The ${screen} pane.\n *\n * Call the query hooks this pane renders *here*, not on the screen above it:\n * a result handed down ties every sibling to a query it never asked for, and\n * \`pnpm check:structure\` says so. See .agents/rules/frontend-architecture.md.\n */\nexport function ${component}Panel() {\n  const { t } = useTranslation();\n\n  return <p>{t('common.appName')}</p>;\n}\n`;
