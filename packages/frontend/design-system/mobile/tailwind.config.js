...
/**
 * Alpaca Labs brand theme for NativeWind. Mirrors the web design system so a
 * component's classes mean the same thing on both platforms.
 *
 * Consumers must include this config's `content` entries in their own content
 * list because Tailwind does not merge content paths from presets.
 */
