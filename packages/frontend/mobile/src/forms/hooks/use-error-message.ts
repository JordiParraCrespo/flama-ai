 ...
 * failure message, keyed by the API's problem `code`. The web kit ships the
 * same hook; this is the Expo half of it.
 *
 ...
 * <AuthFormError>{resolveError(error, t('auth.login.invalidCredentials')).message}</AuthFormError>
 * ```
 */
