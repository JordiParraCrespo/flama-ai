 ...
 * design system's icon set: Lucide dropped brand logos, and Google's has to
 * keep its four colours, which a monochrome set cannot carry. The paths are
 * the same ones `@flama/frontend-web` uses.
 */
