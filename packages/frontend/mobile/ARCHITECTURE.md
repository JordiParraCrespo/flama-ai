...
mobile half of `@flama/frontend-web`'s concern of the same name — same names,
...
`defaultQueryClientOptions`, wraps MMKV (`flama.query-cache`) in a
...
6. `pnpm --filter @flama/frontend-mobile arch lint test`.
