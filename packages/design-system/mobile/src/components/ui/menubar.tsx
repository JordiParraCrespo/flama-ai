  ...
  return (
    <>
      ...
      <MenubarPrimitive.Root
        className={cn(
          'bg-background border-border flex h-10 flex-row items-center gap-1 rounded-md border p-1 sm:h-9',
          className,
        )}
  ...
  return (
    ...
    >
      <MenubarPrimitive.SubTrigger
        className={cn(
          'active:bg-accent group flex flex-row items-center rounded-md px-2 py-2 sm:py-1.5',
          Platform.select({
  ...
  return (
    <NativeOnlyAnimatedView entering={FadeIn}>
      <MenubarPrimitive.SubContent
        className={cn(
          'bg-popover border-border overflow-hidden rounded-2xl border p-1 shadow-lg shadow-black/5',
          Platform.select({
        ...
        >
          <TextClassContext.Provider value="text-popover-foreground">
            <MenubarPrimitive.Content
              className={cn(
                'bg-popover border-border min-w-[12rem] overflow-hidden rounded-2xl border p-1 shadow-lg shadow-black/5',
                Platform.select({
                  web: cn(
