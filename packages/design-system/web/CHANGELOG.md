...
- 97f6f1e: Rebrand the design system onto the Alpaca Labs visual language, on both web and
  mobile.
...
34px`, and the command palette `0 24px 60px rgba(20,20,22,.24)`. All of them
  ...
  pill because the pill _is_ the signal, but across a callout-sized surface it
